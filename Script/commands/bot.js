...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Ovi") || (event.body.toLowerCase() == "Ovi khan") || (event.body.toLowerCase() == "@Ovi khan ッ") || (event.body.toLowerCase() == "অভী")) {
     return api.sendMessage("🦋🍂বস.★❍ꪜ𝗶 Kʜꫝn★এখন কাজে বিজি আছেন কি বলবেন আমাকে বলতে পারেন🍂😘",threadID);
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "তোর বস কে ")) {
     return api.sendMessage("My Creator:❍ꪜ𝗶 Kʜꫝn ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস ☫অভী☫ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "বটের এডমিন")) {
     return api.sendMessage("He is ❍ꪜ𝗶 Kʜꫝn ッ❤️He is ❍ꪜ𝗶 Kʜꫝn ッ❤ তাকে সবাই অভী নামে  চিনে🤙 🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "নুসু") || (event.body.toLowerCase() == "আপ্পি")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস অভী এর কলিজার টুকরো বোন 🦋🍂🥀..!", threadID);
   };

  if ((event.body.toLowerCase() == "@MD Hasan Ahmed ") || (event.body.toLowerCase() == "হাসান")) {
     return api.sendMessage("🥰-হাসান-🌺 আমার বসঅভীর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Ovi") || (event.body.toLowerCase() == "kire")) {
